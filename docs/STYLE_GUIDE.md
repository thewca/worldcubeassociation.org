...
If you are specifically working with UI layout / design components (as opposed to
fixing the state or behavior of a component), you will most likely also need to read
the guide on [Chakra UI](style/chakra-ui.md).
...
**Read it when:** you are working on design (UI and UX) of the new frontend
under the `/next-frontend` folder.

This may also be worth a read if you're going to work mainly in frontend, and you expect to submit
