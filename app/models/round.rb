...
class Round < ApplicationRecord
  ...
  def live_podium
    linked_round.present? ? linked_round.merged_live_results.filter { it.complete? && it.global_pos.in?(1..3) && it.advancing } : live_results.where(global_pos: 1..3, advancing: true)
  end
