...
class Round < ApplicationRecord
  ...
  has_many :matched_scramble_sets, -> { order(:ordered_index) }, class_name: 'ExternalScrambleSet', foreign_key: "matched_round_id", inverse_of: :matched_round, dependent: :nullify
