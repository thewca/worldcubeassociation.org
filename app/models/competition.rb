  ...
  def to_competition_info
    options = {
      ...
      methods: %w[url website short_name city venue_address venue_details latitude_degrees longitude_degrees country_iso2 event_ids
                  main_event_id number_of_bookmarks using_payment_integrations? connected_payment_integration_types uses_qualification? uses_cutoff? competition_series_ids registration_full?
