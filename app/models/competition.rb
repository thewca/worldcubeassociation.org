...
class Competition < ApplicationRecord
  ...
  def registration_full_message
    if registration_full? && registrations.accepted.count >= competitor_limit
      I18n.t(uses_new_registration_service? ? 'registrations.registration_full_v2_html' : 'registrations.registration_full', competitor_limit: competitor_limit, here: "<a href='#{Rails.application.routes.url_helpers.competition_waiting_list_url(self)}'>here</a>")
    else
