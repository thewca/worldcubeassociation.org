...
class Api::Internal::V1::PaymentController < Api::Internal::V1::ApiController
  ...
  def init_stripe
    ...
    ms_registration = competition.microservice_registrations.find_by(user_id: registering_user_id)
    ...
    payment_intent = PaymentIntent.prepare_intent_for(payment_account, ms_registration, amount_iso, currency_iso)
