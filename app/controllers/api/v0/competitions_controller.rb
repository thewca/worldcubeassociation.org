...
class Api::V0::CompetitionsController < Api::V0::ApiController
  ...
  def competition_index
    ...
    serial_methods = %w[short_display_name city country_iso2 event_ids latitude_degrees longitude_degrees announced_at has_any_championship]
    serial_includes = {}
    ...
    paginate json: competitions,
             only: %w[id name start_date end_date registration_open registration_close venue competitor_limit main_event_id has_any_championship],
