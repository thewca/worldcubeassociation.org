...
class PersonsController < ApplicationController
  ...
  def show
    ...
    @results = @person.results.includes(:competition, :event, :format, :round_type).order("events.rank, competitions.start_date DESC, competitions.competition_id, round_types.rank DESC")
