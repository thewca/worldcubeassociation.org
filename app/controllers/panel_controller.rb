...
class PanelController < ApplicationController
  ...
  before_action -> { redirect_to_root_unless_user(:can_access_panel?, params[:action].to_sym) }, except: [:pending_claims_for_subordinate_delegates, :generate_db_token, :index]
