...
#----------------------------------------------------------------------
  ...
  echo "<li><p>Generate the complete <a href='registration_set_spreadsheet.php?competitionId=$chosenCompetitionId&amp;password=$data[password]'>registration excel sheet</a> in .xlsx format (still in development).</p></li>\n"; 
