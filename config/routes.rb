...
Rails.application.routes.draw do
  ...
  get '/regulations/wca-regulations-appended-guidelines', to: redirect('https://regulations.worldcubeassociation.org/wca-regulations-and-guidelines.pdf', status: 302)
  get '/regulations/full/wca-regulations-merged-guidelines', to: redirect('https://regulations.worldcubeassociation.org/wca-regulations-and-guidelines.merged.pdf', status: 302)
