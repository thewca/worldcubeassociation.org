...
--
-- Table structure for table `ResultAttempts`
--

DROP TABLE IF EXISTS `ResultAttempts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `ResultAttempts` (
...
--
-- Dumping data for table `ResultAttempts`
--

LOCK TABLES `ResultAttempts` WRITE;
/*!40000 ALTER TABLE `ResultAttempts` DISABLE KEYS */;
INSERT INTO `ResultAttempts` VALUES
...
/*!40000 ALTER TABLE `ResultAttempts` ENABLE KEYS */;
UNLOCK TABLES;
...
('LyonOpen2007','333','1',15,1968,2128,'Etienne Amany','2007AMAN01','Cote d_Ivoire','a',0,0,0,0,0,'AfR','AfR'),
('LyonOpen2007','333','1',16,1731,2140,'Thomas Rouault','2004ROUA01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','1',17,2305,2637,'Antoine Simon-Chautemps','2005SIMO01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','1',18,2452,2637,'Irène Mallordy','2007MALL01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','1',19,2677,2906,'Marlène Desmaisons','2007DESM01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','1',20,1869,2910,'Ton Dennenbroek','2003DENN01','Netherlands','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','1',21,2411,2910,'Arnaud van Galen','2006GALE01','Netherlands','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','1',22,2385,3111,'Cyrille Cornu','2007CORN01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','1',23,2639,3111,'Christophe Woittequand','2005WOIT01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','1',24,2687,3265,'Georges Poinsot','2007POIN01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','1',25,2934,3337,'Laetitia Lemoine','2007LEMO01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','1',26,3062,3949,'Jean-Louis Mathieu','2006MATH01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','1',27,3609,4430,'Guillaume Terrancle','2007TERR01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','1',28,4416,4894,'Maria Oey','2007OEYM01','Indonesia','a',0,0,0,0,0,NULL,'NR'),
('LyonOpen2007','333','1',29,3727,5327,'Olivier Pibarot','2007PIBA01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','1',30,5484,8876,'Pierre-Baptiste Boccard','2007BOCC01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','2',1,1141,1242,'Edouard Chambon','2004CHAM01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','2',2,1168,1320,'Jean Pons','2004PONS01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','2',3,1078,1374,'Joël van Noort','2004NOOR01','Netherlands','a',0,0,0,0,0,'NR',NULL),
('LyonOpen2007','333','2',4,1240,1427,'Thibaut Jacquinot','2006JACQ01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','2',5,1346,1624,'Rama Temmink','2006TEMM01','Netherlands','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','2',6,1453,1626,'Lars Vandenbergh','2003VAND01','Belgium','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','2',7,1522,1758,'Thomas Watiotienne','2007WATI01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','2',8,1630,1764,'Gilles van den Peereboom','2005PEER01','Belgium','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','2',9,1466,1815,'Gilles Roux','2004ROUX01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','2',10,1621,1853,'Guillaume Meunier','2004MEUN01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','2',11,1650,1859,'Aurelien Souchet (高凡)','2006SOUC01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','2',12,1645,1899,'Thomas Rouault','2004ROUA01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','2',13,1655,1899,'Ton Dennenbroek','2003DENN01','Netherlands','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','2',14,1684,1947,'Stefan Huber','2007HUBE01','Austria','a',0,0,0,0,0,NULL,'NR'),
('LyonOpen2007','333','2',15,1985,2124,'Frédérick Badie','2003BADI01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','2',16,1696,2233,'Antoine Simon-Chautemps','2005SIMO01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','2',17,2224,2640,'Etienne Amany','2007AMAN01','Cote d_Ivoire','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','2',18,2390,2735,'Marlène Desmaisons','2007DESM01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','2',19,2506,2779,'Irène Mallordy','2007MALL01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','2',20,2628,2916,'Arnaud van Galen','2006GALE01','Netherlands','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','2',21,1786,2933,'Clément Gallet','2004GALL02','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','f',1,1059,1271,'Jean Pons','2004PONS01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','f',2,1205,1320,'Edouard Chambon','2004CHAM01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','f',3,1197,1395,'Joël van Noort','2004NOOR01','Netherlands','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','f',4,1292,1424,'Thibaut Jacquinot','2006JACQ01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','f',5,1383,1603,'Gilles Roux','2004ROUX01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','f',6,1601,1615,'Rama Temmink','2006TEMM01','Netherlands','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','f',7,1444,1616,'Lars Vandenbergh','2003VAND01','Belgium','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','f',8,1575,1707,'Gilles van den Peereboom','2005PEER01','Belgium','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333','f',9,1811,2131,'Guillaume Meunier','2004MEUN01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333oh','d',1,1858,2410,'Rama Temmink','2006TEMM01','Netherlands','a',0,0,0,0,0,'NR','NR'),
('LyonOpen2007','333oh','d',2,1865,2445,'Gilles van den Peereboom','2005PEER01','Belgium','a',0,0,0,0,0,'NR','NR'),
('LyonOpen2007','333oh','d',3,2269,2530,'Thibaut Jacquinot','2006JACQ01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333oh','d',4,2492,2770,'Edouard Chambon','2004CHAM01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333oh','d',5,2281,2894,'Aurelien Souchet (高凡)','2006SOUC01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333oh','d',6,2669,3082,'Joël van Noort','2004NOOR01','Netherlands','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333oh','d',7,3303,4194,'Thomas Watiotienne','2007WATI01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333oh','d',8,3544,4239,'Clément Gallet','2004GALL02','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333oh','d',9,4527,4764,'Arnaud van Galen','2006GALE01','Netherlands','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333oh','d',10,4494,4938,'Gilles Roux','2004ROUX01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333oh','d',11,5388,5906,'Stefan Huber','2007HUBE01','Austria','a',0,0,0,0,0,'NR','NR'),
('LyonOpen2007','333oh','d',12,5704,6795,'Ton Dennenbroek','2003DENN01','Netherlands','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333oh','d',13,6084,0,'Antoine Simon-Chautemps','2005SIMO01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333oh','d',14,6684,0,'Christophe Woittequand','2005WOIT01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333oh','d',15,7259,0,'Etienne Amany','2007AMAN01','Cote d_Ivoire','a',0,0,0,0,0,'NR',NULL),
('LyonOpen2007','333oh','d',16,8467,0,'Irène Mallordy','2007MALL01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333oh','d',17,13775,0,'Laetitia Lemoine','2007LEMO01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333oh','f',1,2094,2186,'Rama Temmink','2006TEMM01','Netherlands','a',0,0,0,0,0,NULL,'ER'),
('LyonOpen2007','333oh','f',2,2273,2507,'Edouard Chambon','2004CHAM01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333oh','f',3,2414,2581,'Gilles van den Peereboom','2005PEER01','Belgium','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333oh','f',4,2457,2673,'Thibaut Jacquinot','2006JACQ01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333oh','f',5,2672,2817,'Aurelien Souchet (高凡)','2006SOUC01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333oh','f',6,3031,3334,'Joël van Noort','2004NOOR01','Netherlands','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333oh','f',7,3618,4012,'Clément Gallet','2004GALL02','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333oh','f',8,3571,4280,'Thomas Watiotienne','2007WATI01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','444','c',1,6249,6611,'Jean Pons','2004PONS01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','444','c',2,6696,7105,'Lars Vandenbergh','2003VAND01','Belgium','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','444','c',3,5819,7269,'Thibaut Jacquinot','2006JACQ01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','444','c',4,6822,7605,'Frédérick Badie','2003BADI01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','444','c',5,7667,8703,'Rama Temmink','2006TEMM01','Netherlands','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','444','c',6,7943,8726,'Clément Gallet','2004GALL02','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','444','c',7,8490,8833,'Gilles van den Peereboom','2005PEER01','Belgium','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','444','c',8,7131,9390,'Thomas Watiotienne','2007WATI01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','444','c',9,8516,9537,'Aurelien Souchet (高凡)','2006SOUC01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','444','c',10,8346,9641,'Gilles Roux','2004ROUX01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','444','c',11,8890,10391,'Arnaud van Galen','2006GALE01','Netherlands','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','444','c',12,10171,11797,'Antoine Simon-Chautemps','2005SIMO01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','444','c',13,12331,0,'Cyrille Cornu','2007CORN01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','444','c',14,13936,0,'Ton Dennenbroek','2003DENN01','Netherlands','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','444','c',15,18544,0,'Jean-Louis Mathieu','2006MATH01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','444','c',16,25774,0,'Maria Oey','2007OEYM01','Indonesia','a',0,0,0,0,0,'NR',NULL),
('LyonOpen2007','555','c',1,11108,11731,'Frédérick Badie','2003BADI01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','555','c',2,12051,12294,'Rama Temmink','2006TEMM01','Netherlands','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','555','c',3,12453,13688,'Lars Vandenbergh','2003VAND01','Belgium','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','555','c',4,13281,14193,'Joël van Noort','2004NOOR01','Netherlands','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','555','c',5,13795,16272,'Clément Gallet','2004GALL02','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','555','c',6,15528,16968,'Arnaud van Galen','2006GALE01','Netherlands','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','555','c',7,15560,18032,'Gilles van den Peereboom','2005PEER01','Belgium','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','555','c',8,18853,19691,'Aurelien Souchet (高凡)','2006SOUC01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','555','c',9,27100,0,'Ton Dennenbroek','2003DENN01','Netherlands','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','555','c',10,30156,0,'Gilles Roux','2004ROUX01','France','a',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333bf','f',1,16910,-1,'Clément Gallet','2004GALL02','France','3',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333bf','f',2,21930,-1,'Joël van Noort','2004NOOR01','Netherlands','3',0,0,0,0,0,NULL,NULL),
('LyonOpen2007','333bf','f',3,21969,-1,'Jean Pons','2004PONS01','France','3',0,0,0,0,0,NULL,NULL);
...
-- Dump completed on 2025-11-24 16:32:47
