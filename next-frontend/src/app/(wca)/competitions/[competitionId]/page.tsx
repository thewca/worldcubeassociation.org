    ...
    <Container minW="80vw" p="8">
      ...
      >
                ...
                <Card.Body>
                  ...
                  <SimpleGrid columns={2} gap="4">
                    ...
                    <Card.Root variant="infoSnippet">
                      ...
                      <Card.Body>
                        <FormatNumber
                          value={competitionInfo.competitor_limit}
                        />
                      </Card.Body>
                    </Card.Root>
                    ...
                    <Card.Root variant="infoSnippet">
                      ...
                      <Card.Body>
                        <FormatNumber
                          value={competitionInfo.number_of_bookmarks}
                        />{" "}
                        Times
                      </Card.Body>
                    </Card.Root>
              ...
              <Card.Root variant="plain">
                <Card.Body>
                  ...
                  <Text>
                    ...
                    {formattedRefundDate} you will be refunded
        ...
        <Tabs.Content value="schedule">
          <TabSchedule competitionId={competitionInfo.id} />
        </Tabs.Content>
        <Tabs.Content value="custom-1">
          <MarkdownProse content={competitionInfo.information} />
        </Tabs.Content>
        <Tabs.Content value="custom-2">
          <MarkdownProse content={competitionInfo.information} />
        </Tabs.Content>
        <Tabs.Content value="custom-3">
          <MarkdownProse content={competitionInfo.information} />
        </Tabs.Content>
      </Tabs.Root>
    </Container>
