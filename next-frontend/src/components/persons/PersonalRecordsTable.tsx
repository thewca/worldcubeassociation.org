        ...
        <Table.Root size="sm" striped rounded="md" variant="results">
          <Table.Header>
            <Table.Row bg="bg.inverted">
              <Table.ColumnHeader color="fg.inverted" pl="3"><Flex direction="row"><Box fontSize="18px" pr="5px"><SpeedcubingHistoryIcon/></Box><Text fontWeight="medium">Event</Text></Flex></Table.ColumnHeader>
