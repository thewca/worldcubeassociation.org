...
--
-- Host: wca_db    Database: results_dump_v2
-- ------------------------------------------------------
...
CREATE TABLE `competitions` (
  ...
  `city_name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  ...
  `end_month` smallint unsigned NOT NULL DEFAULT '0',
  `end_day` smallint unsigned NOT NULL DEFAULT '0',
  `cancelled` int NOT NULL DEFAULT '0',
  `event_specs` longtext COLLATE utf8mb4_unicode_ci,
  `delegates` mediumtext COLLATE utf8mb4_unicode_ci,
  `organizers` mediumtext COLLATE utf8mb4_unicode_ci,
  ...
  `venue_details` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `external_website` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `cell_name` varchar(45) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
('4BLDinaMadisonHall2023','4BLD in a Madison Hall 2023','Madison, Wisconsin','USA','Competitors are allowed at most one guest, and no guests may attend unattached to competitors.\r\n\r\nThis competition may be cancelled or other COVID restrictions may be added later if the COVID situation locally or nationally changes.',2023,1,28,2023,1,29,0,'333bf 333fm 333mbf 444bf 555bf clock','[{Carter Kucala}{mailto:31001@worldcubeassociation.org}] [{Joshua Feran}{mailto:7944@worldcubeassociation.org}] [{Zeke Mackay}{mailto:19818@worldcubeassociation.org}]','[{Carter Kucala}{mailto:31001@worldcubeassociation.org}] [{Joshua Feran}{mailto:7944@worldcubeassociation.org}] [{Midwest Cubing Association}{mailto:310337@worldcubeassociation.org}]','Monona Terrace','1 John Nolen Dr, Madison, WI 53703','Hall of Ideas Room J',NULL,'4BLD in a Madison Hall 2023',43071248,-89380468),
('4BLDMadnessinDobrejovice2025','4BLD Madness in Dobřejovice 2025','Dobřejovice','Czech Republic',NULL,2025,10,18,2025,10,18,0,'333bf 444bf 555bf 777 clock','[{Jan Fonš}{mailto:29909@worldcubeassociation.org}] [{Jan Křížka}{mailto:92795@worldcubeassociation.org}]','[{Jan Křížka}{mailto:92795@worldcubeassociation.org}] [{Natálie Rajdusová}{mailto:451233@worldcubeassociation.org}]','[Společenské centrum Dobřejovice](https://www.dobrejovice.cz/zivot-v-obci/sportovni-a-spolecenske-centrum/)','Čestlická 245, Dobřejovice','2nd floor',NULL,'4BLD Madness in Dobřejovice 2025',49983233,14580686),
('4thGuwahatiOpen2018','4th Guwahati Open 2018','Guwahati, Assam','India','There is on-spot registration.\r\nPlease bring your ID cards for identification at the venue.\r\n\r\nWe have a competitor limit of 130 participants which will be filled on First come basis.\r\n\r\nRegistration closes either on 28 August 2018, 23:59. IST or when registration count reaches 130 (whichever comes first)',2018,9,1,2018,9,2,0,'222 333 333bf 333oh 444 555 minx pyram skewb','[{Sachin Arvind}{mailto:96587@worldcubeassociation.org}]','[{Kabyanil Talukdar}{mailto:17767@worldcubeassociation.org}]','Cotton University','Pan Bazar, Guwahati, Assam 781001','Sudmersen Hall, physics department, Cotton University. The hall is opposite of BSNL head office, Panbazar.',NULL,'4th Guwahati Open 2018',26187422,91746736),
('4x4byFourMadisonLakes2024','4x4 by Four Madison Lakes 2024','Madison, Wisconsin','USA','New to competing? This competition is a good one to be your first!\n\nThis competition is supported by the [**Midwest Cubing Association**](https://midwestcubing.org).\n![](https://www.worldcubeassociation.org/rails/active_storage/blobs/redirect/eyJfcmFpbHMiOnsibWVzc2FnZSI6IkJBaHBBZ0dEIiwiZXhwIjpudWxsLCJwdXIiOiJibG9iX2lkIn19--a6239c56608b03fda2194e41dd545ce91819975d/MCA-Final-Logo%20(WCA%20website%20version).png)\n',2024,12,7,2024,12,7,0,'222 333 333oh 444 555','[{Carter Kucala}{mailto:31001@worldcubeassociation.org}] [{Joshua Feran}{mailto:7944@worldcubeassociation.org}] [{Simon Kellum}{mailto:24542@worldcubeassociation.org}] [{Zeke Mackay}{mailto:19818@worldcubeassociation.org}]','[{Carter Kucala}{mailto:31001@worldcubeassociation.org}] [{Midwest Cubing Association}{mailto:310337@worldcubeassociation.org}] [{Simon Kellum}{mailto:24542@worldcubeassociation.org}] [{Zeke Mackay}{mailto:19818@worldcubeassociation.org}]','Monona Terrace','1 John Nolen Dr, Madison, WI 53703','Hall of Ideas',NULL,'4x4 by Four Madison Lakes 2024',43071556,-89380278),
...
CREATE TABLE `continents` (
  ...
  `name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `record_name` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `countries` (
  `id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `name` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `continent_id` varchar(50) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `persons` (
  `wca_id` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
CREATE TABLE `ranks_average` (
  `person_id` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `event_id` varchar(6) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Dumping data for table `ranks_average`
--

LOCK TABLES `ranks_average` WRITE;
/*!40000 ALTER TABLE `ranks_average` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `ranks_average` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `ranks_single`
--

LOCK TABLES `ranks_single` WRITE;
/*!40000 ALTER TABLE `ranks_single` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `ranks_single` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `result_attempts`
--

LOCK TABLES `result_attempts` WRITE;
/*!40000 ALTER TABLE `result_attempts` DISABLE KEYS */;
INSERT INTO `result_attempts` VALUES
(1,1438,1,7081032,'2025-05-06 05:21:04.199475','2025-05-06 05:21:04.199475'),
(2,1352,2,7081032,'2025-05-06 05:21:04.199475','2025-05-06 05:21:04.199475'),
(3,1528,3,7081032,'2025-05-06 05:21:04.199475','2025-05-06 05:21:04.199475'),
(4,1673,4,7081032,'2025-05-06 05:21:04.199475','2025-05-06 05:21:04.199475'),
(5,1445,5,7081032,'2025-05-06 05:21:04.199475','2025-05-06 05:21:04.199475'),
(6,7047,1,7079543,'2025-05-06 05:22:27.955271','2025-05-06 05:22:27.955271'),
(7,-1,2,7079543,'2025-05-06 05:22:27.955271','2025-05-06 05:22:27.955271'),
(8,2166,1,7079253,'2025-05-06 05:23:03.378766','2025-05-06 05:23:03.378766'),
(9,-1,2,7079253,'2025-05-06 05:23:03.378766','2025-05-06 05:23:03.378766'),
(10,1439,3,7079253,'2025-05-06 05:23:03.378766','2025-05-06 05:23:03.378766'),
(11,1747,4,7079253,'2025-05-06 05:23:03.378766','2025-05-06 05:23:03.378766'),
(12,1487,5,7079253,'2025-05-06 05:23:03.378766','2025-05-06 05:23:03.378766'),
(13,1543,1,7079226,'2025-05-06 05:23:03.414719','2025-05-06 05:23:03.414719'),
(14,1827,2,7079226,'2025-05-06 05:23:03.414719','2025-05-06 05:23:03.414719'),
(15,1776,3,7079226,'2025-05-06 05:23:03.414719','2025-05-06 05:23:03.414719'),
(16,1597,4,7079226,'2025-05-06 05:23:03.414719','2025-05-06 05:23:03.414719'),
(17,1323,5,7079226,'2025-05-06 05:23:03.414719','2025-05-06 05:23:03.414719'),
(18,1816,1,7079242,'2025-05-06 05:23:03.449267','2025-05-06 05:23:03.449267'),
(99,9589,2,7089530,'2025-05-06 18:41:19.520989','2025-05-06 18:41:19.520989'),
(100,11118,3,7089530,'2025-05-06 18:41:19.520989','2025-05-06 18:41:19.520989'),
(101,10956,4,7089530,'2025-05-06 18:41:19.520989','2025-05-06 18:41:19.520989'),
(102,9874,5,7089530,'2025-05-06 18:41:19.520989','2025-05-06 18:41:19.520989'),
(103,36425,1,7075622,'2025-05-09 04:02:44.779266','2025-05-09 04:02:44.779266'),
(104,44134,2,7075622,'2025-05-09 04:02:44.779266','2025-05-09 04:02:44.779266'),
(105,-1,3,7075622,'2025-05-09 04:02:44.779266','2025-05-09 04:02:44.779266'),
(106,3014,1,7044275,'2025-05-09 05:32:29.980861','2025-05-09 05:32:29.980861'),
(107,2523,2,7044275,'2025-05-09 05:32:29.980861','2025-05-09 05:32:29.980861'),
(108,1601,3,7044275,'2025-05-09 05:32:29.980861','2025-05-09 05:32:29.980861'),
(109,2584,4,7044275,'2025-05-09 05:32:29.980861','2025-05-09 05:32:29.980861'),
(110,3134,5,7044275,'2025-05-09 05:32:29.980861','2025-05-09 05:32:29.980861'),
(111,-1,1,7044276,'2025-05-09 05:32:29.986378','2025-05-09 05:32:29.986378'),
(112,1038,2,7044276,'2025-05-09 05:32:29.986378','2025-05-09 05:32:29.986378'),
(113,933,3,7044276,'2025-05-09 05:32:29.986378','2025-05-09 05:32:29.986378'),
(114,1036,4,7044276,'2025-05-09 05:32:29.986378','2025-05-09 05:32:29.986378'),
(115,1224,5,7044276,'2025-05-09 05:32:29.986378','2025-05-09 05:32:29.986378');
/*!40000 ALTER TABLE `result_attempts` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `results` (
  ...
  `event_id` varchar(6) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `round_type_id` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `pos` smallint NOT NULL DEFAULT '0',
  `best` int NOT NULL DEFAULT '0',
  `average` int NOT NULL DEFAULT '0',
  `person_name` varchar(80) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `person_id` varchar(10) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `person_country_id` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `format_id` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `regional_single_record` varchar(3) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `regional_average_record` varchar(3) COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
('LyonOpen2007','333','1',15,1968,2128,'Etienne Amany','2007AMAN01','Cote d_Ivoire','a','AfR','AfR'),
('LyonOpen2007','333','1',16,1731,2140,'Thomas Rouault','2004ROUA01','France','a',NULL,NULL),
('LyonOpen2007','333','1',17,2305,2637,'Antoine Simon-Chautemps','2005SIMO01','France','a',NULL,NULL),
('LyonOpen2007','333','1',18,2452,2637,'Irène Mallordy','2007MALL01','France','a',NULL,NULL),
('LyonOpen2007','333','1',19,2677,2906,'Marlène Desmaisons','2007DESM01','France','a',NULL,NULL),
('LyonOpen2007','333','1',20,1869,2910,'Ton Dennenbroek','2003DENN01','Netherlands','a',NULL,NULL),
('LyonOpen2007','333','1',21,2411,2910,'Arnaud van Galen','2006GALE01','Netherlands','a',NULL,NULL),
('LyonOpen2007','333','1',22,2385,3111,'Cyrille Cornu','2007CORN01','France','a',NULL,NULL),
('LyonOpen2007','333','1',23,2639,3111,'Christophe Woittequand','2005WOIT01','France','a',NULL,NULL),
('LyonOpen2007','333','1',24,2687,3265,'Georges Poinsot','2007POIN01','France','a',NULL,NULL),
('LyonOpen2007','333','1',25,2934,3337,'Laetitia Lemoine','2007LEMO01','France','a',NULL,NULL),
('LyonOpen2007','333','1',26,3062,3949,'Jean-Louis Mathieu','2006MATH01','France','a',NULL,NULL),
('LyonOpen2007','333','1',27,3609,4430,'Guillaume Terrancle','2007TERR01','France','a',NULL,NULL),
('LyonOpen2007','333','1',28,4416,4894,'Maria Oey','2007OEYM01','Indonesia','a',NULL,'NR'),
('LyonOpen2007','333','1',29,3727,5327,'Olivier Pibarot','2007PIBA01','France','a',NULL,NULL),
('LyonOpen2007','333','1',30,5484,8876,'Pierre-Baptiste Boccard','2007BOCC01','France','a',NULL,NULL),
('LyonOpen2007','333','2',1,1141,1242,'Edouard Chambon','2004CHAM01','France','a',NULL,NULL),
('LyonOpen2007','333','2',2,1168,1320,'Jean Pons','2004PONS01','France','a',NULL,NULL),
('LyonOpen2007','333','2',3,1078,1374,'Joël van Noort','2004NOOR01','Netherlands','a','NR',NULL),
('LyonOpen2007','333','2',4,1240,1427,'Thibaut Jacquinot','2006JACQ01','France','a',NULL,NULL),
('LyonOpen2007','333','2',5,1346,1624,'Rama Temmink','2006TEMM01','Netherlands','a',NULL,NULL),
('LyonOpen2007','333','2',6,1453,1626,'Lars Vandenbergh','2003VAND01','Belgium','a',NULL,NULL),
('LyonOpen2007','333','2',7,1522,1758,'Thomas Watiotienne','2007WATI01','France','a',NULL,NULL),
('LyonOpen2007','333','2',8,1630,1764,'Gilles van den Peereboom','2005PEER01','Belgium','a',NULL,NULL),
('LyonOpen2007','333','2',9,1466,1815,'Gilles Roux','2004ROUX01','France','a',NULL,NULL),
('LyonOpen2007','333','2',10,1621,1853,'Guillaume Meunier','2004MEUN01','France','a',NULL,NULL),
('LyonOpen2007','333','2',11,1650,1859,'Aurelien Souchet (高凡)','2006SOUC01','France','a',NULL,NULL),
('LyonOpen2007','333','2',12,1645,1899,'Thomas Rouault','2004ROUA01','France','a',NULL,NULL),
('LyonOpen2007','333','2',13,1655,1899,'Ton Dennenbroek','2003DENN01','Netherlands','a',NULL,NULL),
('LyonOpen2007','333','2',14,1684,1947,'Stefan Huber','2007HUBE01','Austria','a',NULL,'NR'),
('LyonOpen2007','333','2',15,1985,2124,'Frédérick Badie','2003BADI01','France','a',NULL,NULL),
('LyonOpen2007','333','2',16,1696,2233,'Antoine Simon-Chautemps','2005SIMO01','France','a',NULL,NULL),
('LyonOpen2007','333','2',17,2224,2640,'Etienne Amany','2007AMAN01','Cote d_Ivoire','a',NULL,NULL),
('LyonOpen2007','333','2',18,2390,2735,'Marlène Desmaisons','2007DESM01','France','a',NULL,NULL),
('LyonOpen2007','333','2',19,2506,2779,'Irène Mallordy','2007MALL01','France','a',NULL,NULL),
('LyonOpen2007','333','2',20,2628,2916,'Arnaud van Galen','2006GALE01','Netherlands','a',NULL,NULL),
('LyonOpen2007','333','2',21,1786,2933,'Clément Gallet','2004GALL02','France','a',NULL,NULL),
('LyonOpen2007','333','f',1,1059,1271,'Jean Pons','2004PONS01','France','a',NULL,NULL),
('LyonOpen2007','333','f',2,1205,1320,'Edouard Chambon','2004CHAM01','France','a',NULL,NULL),
('LyonOpen2007','333','f',3,1197,1395,'Joël van Noort','2004NOOR01','Netherlands','a',NULL,NULL),
('LyonOpen2007','333','f',4,1292,1424,'Thibaut Jacquinot','2006JACQ01','France','a',NULL,NULL),
('LyonOpen2007','333','f',5,1383,1603,'Gilles Roux','2004ROUX01','France','a',NULL,NULL),
('LyonOpen2007','333','f',6,1601,1615,'Rama Temmink','2006TEMM01','Netherlands','a',NULL,NULL),
('LyonOpen2007','333','f',7,1444,1616,'Lars Vandenbergh','2003VAND01','Belgium','a',NULL,NULL),
('LyonOpen2007','333','f',8,1575,1707,'Gilles van den Peereboom','2005PEER01','Belgium','a',NULL,NULL),
('LyonOpen2007','333','f',9,1811,2131,'Guillaume Meunier','2004MEUN01','France','a',NULL,NULL),
('LyonOpen2007','333oh','d',1,1858,2410,'Rama Temmink','2006TEMM01','Netherlands','a','NR','NR'),
('LyonOpen2007','333oh','d',2,1865,2445,'Gilles van den Peereboom','2005PEER01','Belgium','a','NR','NR'),
('LyonOpen2007','333oh','d',3,2269,2530,'Thibaut Jacquinot','2006JACQ01','France','a',NULL,NULL),
('LyonOpen2007','333oh','d',4,2492,2770,'Edouard Chambon','2004CHAM01','France','a',NULL,NULL),
('LyonOpen2007','333oh','d',5,2281,2894,'Aurelien Souchet (高凡)','2006SOUC01','France','a',NULL,NULL),
('LyonOpen2007','333oh','d',6,2669,3082,'Joël van Noort','2004NOOR01','Netherlands','a',NULL,NULL),
('LyonOpen2007','333oh','d',7,3303,4194,'Thomas Watiotienne','2007WATI01','France','a',NULL,NULL),
('LyonOpen2007','333oh','d',8,3544,4239,'Clément Gallet','2004GALL02','France','a',NULL,NULL),
('LyonOpen2007','333oh','d',9,4527,4764,'Arnaud van Galen','2006GALE01','Netherlands','a',NULL,NULL),
('LyonOpen2007','333oh','d',10,4494,4938,'Gilles Roux','2004ROUX01','France','a',NULL,NULL),
('LyonOpen2007','333oh','d',11,5388,5906,'Stefan Huber','2007HUBE01','Austria','a','NR','NR'),
('LyonOpen2007','333oh','d',12,5704,6795,'Ton Dennenbroek','2003DENN01','Netherlands','a',NULL,NULL),
('LyonOpen2007','333oh','d',13,6084,0,'Antoine Simon-Chautemps','2005SIMO01','France','a',NULL,NULL),
('LyonOpen2007','333oh','d',14,6684,0,'Christophe Woittequand','2005WOIT01','France','a',NULL,NULL),
('LyonOpen2007','333oh','d',15,7259,0,'Etienne Amany','2007AMAN01','Cote d_Ivoire','a','NR',NULL),
('LyonOpen2007','333oh','d',16,8467,0,'Irène Mallordy','2007MALL01','France','a',NULL,NULL),
('LyonOpen2007','333oh','d',17,13775,0,'Laetitia Lemoine','2007LEMO01','France','a',NULL,NULL),
('LyonOpen2007','333oh','f',1,2094,2186,'Rama Temmink','2006TEMM01','Netherlands','a',NULL,'ER'),
('LyonOpen2007','333oh','f',2,2273,2507,'Edouard Chambon','2004CHAM01','France','a',NULL,NULL),
('LyonOpen2007','333oh','f',3,2414,2581,'Gilles van den Peereboom','2005PEER01','Belgium','a',NULL,NULL),
('LyonOpen2007','333oh','f',4,2457,2673,'Thibaut Jacquinot','2006JACQ01','France','a',NULL,NULL),
('LyonOpen2007','333oh','f',5,2672,2817,'Aurelien Souchet (高凡)','2006SOUC01','France','a',NULL,NULL),
('LyonOpen2007','333oh','f',6,3031,3334,'Joël van Noort','2004NOOR01','Netherlands','a',NULL,NULL),
('LyonOpen2007','333oh','f',7,3618,4012,'Clément Gallet','2004GALL02','France','a',NULL,NULL),
('LyonOpen2007','333oh','f',8,3571,4280,'Thomas Watiotienne','2007WATI01','France','a',NULL,NULL),
('LyonOpen2007','444','c',1,6249,6611,'Jean Pons','2004PONS01','France','a',NULL,NULL),
('LyonOpen2007','444','c',2,6696,7105,'Lars Vandenbergh','2003VAND01','Belgium','a',NULL,NULL),
('LyonOpen2007','444','c',3,5819,7269,'Thibaut Jacquinot','2006JACQ01','France','a',NULL,NULL),
('LyonOpen2007','444','c',4,6822,7605,'Frédérick Badie','2003BADI01','France','a',NULL,NULL),
('LyonOpen2007','444','c',5,7667,8703,'Rama Temmink','2006TEMM01','Netherlands','a',NULL,NULL),
('LyonOpen2007','444','c',6,7943,8726,'Clément Gallet','2004GALL02','France','a',NULL,NULL),
('LyonOpen2007','444','c',7,8490,8833,'Gilles van den Peereboom','2005PEER01','Belgium','a',NULL,NULL),
('LyonOpen2007','444','c',8,7131,9390,'Thomas Watiotienne','2007WATI01','France','a',NULL,NULL),
('LyonOpen2007','444','c',9,8516,9537,'Aurelien Souchet (高凡)','2006SOUC01','France','a',NULL,NULL),
('LyonOpen2007','444','c',10,8346,9641,'Gilles Roux','2004ROUX01','France','a',NULL,NULL),
('LyonOpen2007','444','c',11,8890,10391,'Arnaud van Galen','2006GALE01','Netherlands','a',NULL,NULL),
('LyonOpen2007','444','c',12,10171,11797,'Antoine Simon-Chautemps','2005SIMO01','France','a',NULL,NULL),
('LyonOpen2007','444','c',13,12331,0,'Cyrille Cornu','2007CORN01','France','a',NULL,NULL),
('LyonOpen2007','444','c',14,13936,0,'Ton Dennenbroek','2003DENN01','Netherlands','a',NULL,NULL),
('LyonOpen2007','444','c',15,18544,0,'Jean-Louis Mathieu','2006MATH01','France','a',NULL,NULL),
('LyonOpen2007','444','c',16,25774,0,'Maria Oey','2007OEYM01','Indonesia','a','NR',NULL),
('LyonOpen2007','555','c',1,11108,11731,'Frédérick Badie','2003BADI01','France','a',NULL,NULL),
('LyonOpen2007','555','c',2,12051,12294,'Rama Temmink','2006TEMM01','Netherlands','a',NULL,NULL),
('LyonOpen2007','555','c',3,12453,13688,'Lars Vandenbergh','2003VAND01','Belgium','a',NULL,NULL),
('LyonOpen2007','555','c',4,13281,14193,'Joël van Noort','2004NOOR01','Netherlands','a',NULL,NULL),
('LyonOpen2007','555','c',5,13795,16272,'Clément Gallet','2004GALL02','France','a',NULL,NULL),
('LyonOpen2007','555','c',6,15528,16968,'Arnaud van Galen','2006GALE01','Netherlands','a',NULL,NULL),
('LyonOpen2007','555','c',7,15560,18032,'Gilles van den Peereboom','2005PEER01','Belgium','a',NULL,NULL),
('LyonOpen2007','555','c',8,18853,19691,'Aurelien Souchet (高凡)','2006SOUC01','France','a',NULL,NULL),
('LyonOpen2007','555','c',9,27100,0,'Ton Dennenbroek','2003DENN01','Netherlands','a',NULL,NULL),
('LyonOpen2007','555','c',10,30156,0,'Gilles Roux','2004ROUX01','France','a',NULL,NULL),
('LyonOpen2007','333bf','f',1,16910,-1,'Clément Gallet','2004GALL02','France','3',NULL,NULL),
('LyonOpen2007','333bf','f',2,21930,-1,'Joël van Noort','2004NOOR01','Netherlands','3',NULL,NULL),
('LyonOpen2007','333bf','f',3,21969,-1,'Jean Pons','2004PONS01','France','3',NULL,NULL);
...
CREATE TABLE `scrambles` (
  ...
  `competition_id` varchar(32) COLLATE utf8mb4_unicode_ci NOT NULL,
  `event_id` varchar(6) COLLATE utf8mb4_unicode_ci NOT NULL,
  `round_type_id` varchar(1) COLLATE utf8mb4_unicode_ci NOT NULL,
...
-- Dump completed on 2025-12-17  9:22:30
