...
RSpec.describe "API Persons" do
  ...
  describe "GET #show" do
    ...
    it "includes personal records in the response" do
      create :ranks_single, personId: person.wca_id, eventId: "333", best: 450
      create :ranks_average, personId: person.wca_id, eventId: "333", best: 590
      get api_v0_person_path(person.wca_id)
      expect(response).to be_successful
      json = response.parsed_body
  ...
  describe 'GET #personal_records' do
    it 'returns personal records json' do
      ...
      create(:ranks_single, personId: user.wca_id)
      create(:ranks_average, personId: user.wca_id)
