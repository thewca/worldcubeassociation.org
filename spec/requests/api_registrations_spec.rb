...
RSpec.describe 'API Registrations' do
  ...
  describe 'POST #create' do
    context 'when creating a registration' do
      ...
      it 'can register if this is the first registration in a series' do
        ...
        post api_v1_competition_registrations_path(competition_a), params: registration_request, headers: headers
      ...
      it 'can register if already have a non-cancelled registration for another series competition' do
        ...
        post api_v1_competition_registrations_path(competition_b), params: registration_request, headers: headers
    ...
    context 'register with qualifications' do
      ...
      it 'registers when qualifications are met' do
        ...
        post api_v1_competition_registrations_path(comp_with_qualifications), params: registration_request, headers: headers
        perform_enqueued_jobs
  ...
  describe 'PATCH #bulk_update' do
    ...
    it 'admin submits a bulk update containing 1 update' do
      ...
      patch bulk_update_api_v1_competition_registrations_path(competition), params: bulk_update_request, headers: headers
  ...
  describe 'GET #list_admin' do
    ...
    it 'returns multiple registrations' do
      ...
      get admin_api_v1_competition_registrations_path(competition), headers: headers
  ...
  describe 'PATCH #uncapture_payment', :disabled do
    context 'manual_status: organizer_approved' do
      let(:payment_intent) { create(:payment_intent, :manual_succeeded, holder: reg) }
      let!(:manual_payment) { payment_intent.payment_record }
      let(:reg_payment) { manual_payment.registration_payment }
      ...
      before do
        headers['Authorization'] = fetch_jwt_token(comp.organizers.first.id)
        params = {registration_ids: [reg.id]}
        patch toggle_payment_capture_api_v1_competition_registrations_path(comp), headers: headers, params: params, as: :json
      end
