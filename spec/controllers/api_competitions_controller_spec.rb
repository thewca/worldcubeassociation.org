...
RSpec.describe Api::V0::CompetitionsController do
  ...
  describe 'GET #index' do
    ...
    it 'can query by country_iso2' do
      vietnam_comp = create(:competition, :confirmed, :visible, countryId: "Vietnam")
      usa_comp = create(:competition, :confirmed, :visible, countryId: "USA")
    ...
    it 'can do a plaintext query' do
      terrible_comp = create(:competition, :confirmed, :visible, name: "A terrible competition 2016", countryId: "USA")
      awesome_comp = create(:competition, :confirmed, :visible, name: "An awesome competition 2016", countryId: "France")
