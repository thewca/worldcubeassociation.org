...
RSpec.feature "competition results" do
  ...
  let(:person_1) { create(:person, name: "Fast Cuber", countryId: "USA") }
  let(:person_2) { create(:person, name: "Slow Cuber", countryId: "USA") }

  let!(:result_1) { create(:result, competition: competition, eventId: "333", roundTypeId: "f", pos: 1, person: person_1) }
  let!(:result_2) { create(:result, competition: competition, eventId: "333", roundTypeId: "f", pos: 2, person: person_2) }
