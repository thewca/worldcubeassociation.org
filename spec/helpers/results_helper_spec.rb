...
RSpec.describe ResultsHelper do
  describe "#historical_pb_markers" do
    ...
    it "returns a hash indicating which of the results given in the chronological order were PBs" do
      results = []
      results << create(:result, person: person, best: 1000, average: 1200)
      results << create(:result, person: person, best: 900, average: 1300)
      results << create(:result, person: person, best: 890, average: 950)
      results << create(:result, person: person, best: 490, average: 990)
      results << create(:result, person: person, best: 870, average: 960)
    ...
    it "marks tie as PB" do
      results = []
      results << create(:result, person: person, best: 1000, average: 1200)
      results << create(:result, person: person, best: 1000, average: 1300)
    ...
    it "doesn't mark uncompleted solves as PB" do
      ...
      results = []
      results << create(:result, competition: combined_round.competition, person: person, best: SolveTime::DNF_VALUE, average: SolveTime::SKIPPED_VALUE, round_type: combined_final, event_id: "333", round: combined_round)
