...
RSpec.describe ResultsHelper do
  describe "#historical_pb_markers" do
    ...
    it "doesn't mark uncompleted solves as PB" do
      ...
      results = []
      results << create(:result, competition: combined_round.competition, person: person, best: SolveTime::DNF_VALUE, average: SolveTime::SKIPPED_VALUE, round_type: combined_final, eventId: "333")
