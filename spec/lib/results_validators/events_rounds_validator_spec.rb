  ...
  context "on InboxResult and Result" do
    ...
    it "triggers events-related errors and warnings" do
      ...
      [Result, InboxResult].each do |model|
        ...
        create(result_kind, :skip_validation, competition: competition2, eventId: "444", skip_round_creation: true)
      end
    ...
    it "triggers rounds-related errors and warnings" do
      ...
      [Result, InboxResult].each do |model|
        ...
        create(result_kind, competition: competition1, eventId: "333")
