  ...
  context "on InboxResult and Result" do
    ...
    context "validation of inbox person data" do
      ...
      it "validates against existing person data" do
        person = create(:person, countryId: "Spain")
        dup_name = create(:inbox_person, name: person.name, competitionId: competition1.id)
        create(:inbox_result,
      ...
      it "validates person data" do
        ...
        res1 = create(:inbox_result, competition: competition2, eventId: "222")
        res1.delete
