  ...
  context "on InboxResult and Result" do
    ...
    it "triggers errors on cutoff and time limits" do
      ...
      [Result, InboxResult].each do |model|
        ...
        create(result_kind, :mo3, competition: competition2, event_id: "777")
    ...
    it "triggers missing round information warning" do
      ...
      [Result, InboxResult].each do |model|
        result_kind = model.model_name.singular.to_sym
        create(result_kind, :skip_validation, competition: competition1, event_id: "333oh", skip_round_creation: true)
      end
    ...
    it "triggers undef time limit warning" do
      ...
      create(:result, competition: competition1, event_id: "333oh")
      irv = IRV.new.validate(competition_ids: competition1.id)
    ...
    it "triggers mismatched result format error" do
      ...
      [Result, InboxResult].each do |model|
        result_kind = model.model_name.singular.to_sym
        create(result_kind, competition: competition1, event_id: "444")
        res_ko = create(result_kind, :skip_validation, :mo3, competition: competition1, event_id: "444", skip_round_creation: true)
    ...
    it "triggers several warnings about results" do
      ...
      [Result, InboxResult].each do |model|
        ...
        res22 = create(result_kind, competition: competition2, event_id: "222")
        ...
        res_sim1 = create(result_kind, competition: competition2, event_id: "222")
