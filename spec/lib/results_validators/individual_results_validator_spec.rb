  ...
  context "on InboxResult and Result" do
    ...
    it "triggers errors on cutoff and time limits" do
      ...
      [Result, InboxResult].each do |model|
        ...
        res_cumul = create(result_kind, :mo3, competition: competition2, eventId: "666", best: 6000)
        create(result_kind, competition: competition2, eventId: "555", best: 6000, average: 6000, person: person_for_result(res_cumul))
        ...
        create(result_kind, :mo3, competition: competition2, eventId: "777")
    ...
    it "triggers missing round information warning" do
      ...
      [Result, InboxResult].each do |model|
        result_kind = model.model_name.singular.to_sym
        create(result_kind, :skip_validation, competition: competition1, eventId: "333oh", skip_round_creation: true)
      end
    ...
    it "triggers undef time limit warning" do
      ...
      create(:round, competition: competition1, event_id: "333oh", format_id: "a", time_limit: nil)
      create(:result, competition: competition1, eventId: "333oh")
      irv = IRV.new.validate(competition_ids: competition1.id)
    ...
    it "triggers mismatched result format error" do
      ...
      create(:round, competition: competition1, event_id: "444")

      [Result, InboxResult].each do |model|
        result_kind = model.model_name.singular.to_sym
        create(result_kind, competition: competition1, eventId: "444")
        res_ko = create(result_kind, :skip_validation, :mo3, competition: competition1, eventId: "444", skip_round_creation: true)
    ...
    it "triggers several warnings about results" do
      ...
      create(:round, competition: competition2, event_id: "222")
      create(:round, competition: competition1, event_id: "333mbf", format_id: "3")
      tl = TimeLimit.new(centiseconds: 2.minutes.in_centiseconds, cumulative_round_ids: ["333bf-r1"])
      create(:round, competition: competition1, event_id: "333bf",
      ...
      [Result, InboxResult].each do |model|
        ...
        res22 = create(result_kind, competition: competition2, eventId: "222")
        ...
        res_sim1 = create(result_kind, competition: competition2, eventId: "222")
        ...
        res_bf = create(result_kind, :blind_dnf_mo3, competition: competition1, best: 100_00, value1: -1)
