  ...
  context "on InboxResult and Result" do
    ...
    context "for competitions having a competitor limit" do
      before(:example) do
        [Result, InboxResult].each do |model|
          ...
          create_list(result_kind, 10, competition: competition1, eventId: "333oh")
          create_list(result_kind, 10, competition: competition2, eventId: "222")
        end
      end
      ...
      it "complains when it should" do
        create(:result, competition: competition2, eventId: "222")
        create(:inbox_result, competition: competition2, eventId: "222")
        expected_warnings = [
    ...
    context "for competitions without competitor limit enabled" do
      it "doesn't complain" do
        ...
        [Result, InboxResult].each do |model|
          result_kind = model.model_name.singular.to_sym
          create_list(result_kind, 12, competition: competition1, eventId: "333oh")
          create_list(result_kind, 12, competition: competition2, eventId: "222")
        end
