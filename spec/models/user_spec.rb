...
RSpec.describe User, type: :model do
  ...
  it "search returns only people with subId 1" do
    create(:person, wca_id: "2005FLEI01", subId: 1)
    create(:person, wca_id: "2005FLEI01", subId: 2)
  ...
  describe "WCA ID" do
    ...
    it "does not allows assigning WCA ID if user and person details don't match" do
      ...
      person = create(:person, name: "Else", countryId: "United Kingdom", dob: '1900-01-01', gender: "f")
