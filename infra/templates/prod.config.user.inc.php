...
$cfg['Servers'][$i]['port'] = '';
$cfg['Servers'][$i]['host'] = 'worldcubeassociation-dot-org.comp2du1hpno.us-west-2.rds.amazonaws.com';
...
$cfg['Servers'][$i]['verbose'] = '';
$cfg['Servers'][$i]['port'] = '';
$cfg['Servers'][$i]['host'] = 'readonly-worldcubeassociation-dot-org.comp2du1hpno.us-west-2.rds.amazonaws.com';
$cfg['Servers'][$i]['connect_type'] = 'tcp';
$cfg['Servers'][$i]['auth_type'] = 'cookie';
// The RDS IAM Authentication requires SSL
$cfg['Servers'][$i]['ssl'] = true;
