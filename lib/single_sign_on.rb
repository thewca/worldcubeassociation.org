...
# NOTE: this is based on the reference implementation provided by Discourse.
# This file is under the GPLv2 license at the time of writing, the Discourse
# repository is here: https://github.com/discourse/discourse.
# It has been modified to include our own Discourse URL/secret.
class SingleSignOn
  ...
  def self.sso_secret
    AppSecrets.DISCOURSE_SECRET
  end

  def self.sso_url
    "#{EnvConfig.DISCOURSE_URL}/session/sso_login?"
  end
