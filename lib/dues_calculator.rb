...
module DuesCalculator
  ...
  def self.dues_per_competitor_in_usd(country_iso2, base_entry_fee_lowest_denomination, currency_code)
    ...
    due_percent_registration_fee = country_band_detail.due_percent_registration_fee
    registration_fee_dues = registration_fees_in_usd * due_percent_registration_fee / 100.0

    # Calculation of 'country band dues'
    due_amount_per_competitor_us_cents = country_band_detail.due_amount_per_competitor_us_cents
