  ...
  module CompetingLane
    ...
    def self.update!(lane_params, current_user_id, competition_id)
      ...
      ActiveRecord::Base.transaction do
        ...
        changes = registration.changes.map { |key,change| [key, change[1]] }.to_h
        ...
        registration.save!
        registration.add_history_entry(changes, 'user', current_user_id, self.action_type(lane_params, current_user_id))
      end
