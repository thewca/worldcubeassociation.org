...
ActiveRecord::Schema[8.1].define(version: 2026_01_12_140926) do
  ...
  create_table "result_attempts", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "value", null: false
    t.index ["result_id", "attempt_number", "value"], name: "idx_on_result_id_attempt_number_value_9242b6aa76"
