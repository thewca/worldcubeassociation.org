  ...
  def to_comp_form
    {
      ...
      "end_date" => end_date,
      "competition_series" => part_of_competition_series? ? competition_series.to_comp_form : nil,
      ...
      "championships" => championships.map(&:to_comp_form),
      ...
      "can_edit_registration_fees" => can_edit_registration_fees?,
      ...
      "on_the_spot_entry_fee_lowest_denomination" => on_the_spot_entry_fee_lowest_denomination,
      ...
      "main_event_options" => events.map { |event| [event.name, event.id] },
      "remarks" => remarks,
      "can_clone_tabs" => being_cloned_from&.tabs&.present?,
    }
  end
end
