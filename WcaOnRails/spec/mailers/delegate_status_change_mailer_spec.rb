...
RSpec.describe DelegateStatusChangeMailer, type: :mailer do
  describe "notify_board_and_assistants_of_delegate_status_change" do
    ...
    it "email headers are correct" do
      ...
      mail = DelegateStatusChangeMailer.notify_board_and_assistants_of_delegate_status_change(user, senior_delegate1, senior_delegate1)
    ...
    it "promoting a Junior delegate to a delegate" do
      ...
      mail = DelegateStatusChangeMailer.notify_board_and_assistants_of_delegate_status_change(delegate, senior_delegate1, senior_delegate1)
    ...
    it "renders a warning if someone other than their senior delegate makes the change" do
      delegate.update!(delegate_status: "delegate")
      mail = DelegateStatusChangeMailer.notify_board_and_assistants_of_delegate_status_change(delegate, senior_delegate2, senior_delegate1)
