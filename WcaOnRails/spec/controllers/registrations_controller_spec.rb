...
RSpec.describe RegistrationsController do
  context "signed in as organizer" do
    ...
    it "can delete multiple registrations" do
      ...
      expect do
        xhr :patch, :do_actions_for_slected, competition_id: competition.id, registrations_action: "delete-selected",
    ...
    it "can reject multiple registrations" do
      ...
      expect do
        xhr :patch, :do_actions_for_slected, competition_id: competition.id, registrations_action: "reject-selected",
    ...
    it "can accept multiple registrations" do
      ...
      expect do
        xhr :patch, :do_actions_for_slected, competition_id: competition.id, registrations_action: "accept-selected",
