...
RSpec.describe Api::V0::ApiController, clean_db_with_truncation: true do
  ...
  describe 'GET #delegates' do
    it 'includes emails and regions' do
      ...
      delegate = FactoryBot.create :delegate, region: "SF bay area, USA", senior_delegate: senior_delegate, region_id: africa_region.id
      ...
      expect(delegate_json["region_id"]).to eq africa_region.id
    end
