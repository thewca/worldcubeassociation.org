...
RSpec.describe IncidentsController, type: :controller do
  ...
  describe "GET #edit" do
    it "returns a success response" do
      incident = Incident.create! valid_attributes
      get :edit, params: { id: incident.to_param }, session: valid_session
      expect(response).to be_success
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Incident" do
        expect {
          post :create, params: { incident: valid_attributes }, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: { incident: invalid_attributes }, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested incident" do
        incident = Incident.create! valid_attributes
        put :update, params: { id: incident.to_param, incident: new_attributes }, session: valid_session
        incident.reload
      ...
      it "redirects to the incident" do
        incident = Incident.create! valid_attributes
        put :update, params: { id: incident.to_param, incident: valid_attributes }, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        incident = Incident.create! valid_attributes
        put :update, params: { id: incident.to_param, incident: invalid_attributes }, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested incident" do
      incident = Incident.create! valid_attributes
      expect {
        delete :destroy, params: { id: incident.to_param }, session: valid_session
      }.to change(Incident, :count).by(-1)
    end
