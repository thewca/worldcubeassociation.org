...
RSpec.describe LightResult do
  def build_result(args)
    LightResult.new(args, Country.c_find(args["countryId"]), Format.c_find(args["formatId"]), RoundType.c_find(args["roundTypeId"]), Event.c_find(args["eventId"]))
  end
  ...
  describe "trimmed_indices" do
    ...
    it "does not trim anything for format: mean" do
      result = build_result "eventId" => "333", "value1" => 20, "value2" => 10, "value3" => 60, "value4" => SolveTime::SKIPPED_VALUE, "value5" => SolveTime::SKIPPED_VALUE, "average" => 30, "formatId" => "m"
