...
RSpec.describe LightResult do
  ...
  it "correctly computes best_index and worst_index" do
    result = build_result("value1" => 10, "value2" => 30, "value3" => 50, "value4" => 40, "value5" => 60)
  ...
  describe "trimmed_indices" do
    it "trims best and worst for format: average" do
      result = build_result "value1" => 20, "value2" => 10, "value3" => 60, "value4" => 40, "value5" => 50, "formatId" => "a"
      expect(result.trimmed_indices).to eq [ 1, 2 ]
    end

    it "does not trim anything for format: mean" do
      result = build_result "value1" => 20, "value2" => 10, "value3" => 60, "value4" => SolveTime::SKIPPED_VALUE, "value5" => SolveTime::SKIPPED_VALUE, "average" => 30, "formatId" => "m"
      expect(result.trimmed_indices).to eq []
    end

    it "handles combined rounds" do
      result = build_result "value1" => 20, "value2" => 10, "value3" => 60, "value4" => SolveTime::SKIPPED_VALUE, "value5" => SolveTime::SKIPPED_VALUE, "average" => SolveTime::SKIPPED_VALUE, "formatId" => "a"
      expect(result.trimmed_indices).to eq []
    end
  end
  ...
  describe "solves" do
    ...
    it "returns 5 SolveTimes even for a round with 3 solves" do
      result = build_result "value1" => 20, "value2" => 10, "value3" => 60, "value4" => SolveTime::SKIPPED_VALUE, "value5" => SolveTime::SKIPPED_VALUE, "average" => SolveTime::SKIPPED_VALUE, "formatId" => "3"
