...
RSpec.describe MergePeople do
  ...
  let(:person2) { FactoryGirl.create(:person, shared_attributes) }
  ...
  it "requires person1 not have multiple subIds" do
    merge_people.person1_wca_id = FactoryGirl.create(:person_with_multiple_sub_ids, shared_attributes).wca_id
  ...
  it "requires person2 not have multiple subIds" do
    merge_people.person2_wca_id = FactoryGirl.create(:person_with_multiple_sub_ids, shared_attributes).wca_id
