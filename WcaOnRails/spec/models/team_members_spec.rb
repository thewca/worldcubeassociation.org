...
describe TeamMember do
  ...
  let(:delegate_team) { FactoryGirl.create(:team, name: 'Delegate Testing Team', committee: delegates_committee) }
  ...
  it "ensures a user cannot have overlapping memberships to a single team" do
    team_member = FactoryGirl.create :team_member, start_date: 4.months.ago, end_date: 2.months.ago
    team_member2 = FactoryGirl.build :team_member, start_date: 3.months.ago, end_date: 1.month.ago, user_id: team_member.user_id, team_id: team_member.team_id, committee_position_id: team_member.committee_position_id
