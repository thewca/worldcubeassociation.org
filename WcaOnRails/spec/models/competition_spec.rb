  ...
  context "when it is part of a Series" do
    ...
    context "checks WCRP requirements" do
      it "cannot link two competitions that are more than 100km apart" do
        too_far_away_competition = FactoryBot.build :competition, competition_series: series, latitude: -33_856_659, longitude: 151_215_522, starts: competition.start_date
      ...
      it "cannot link two competitions that are more than 33 days apart" do
        too_long_ago_competition = FactoryBot.build :competition, competition_series: series, latitude: competition.latitude, longitude: competition.longitude, starts: 3.years.ago
      ...
      it "cannot extend the WCRP limitations by transitive property" do
        ...
        one_end_competition = FactoryBot.create :competition, name: "One End Open 2015", competition_series: straight_line_series,
                                                              latitude: 0, longitude: 0, starts: DateTime.now
        ...
        middle_competition = FactoryBot.create :competition, name: "Middle Open 2015", competition_series: straight_line_series,
                                                             latitude: 0, longitude: under_hundred_km_microdegrees, starts: DateTime.now
        ...
        other_end_competition = FactoryBot.build :competition, name: "Other End Open 2015", competition_series: straight_line_series,
                                                               latitude: 0, longitude: 2 * under_hundred_km_microdegrees, starts: DateTime.now
    ...
    it "does not include itself as a sibling" do
      partner_competition = FactoryBot.create :competition, competition_series: series, latitude: competition.latitude, longitude: competition.longitude, starts: competition.start_date
    ...
    context "it can be linked with more than one competition" do
      let!(:same_place_different_day) { FactoryBot.create :competition, competition_series: series, latitude: competition.latitude, longitude: competition.longitude, starts: competition.start_date + 1.week }
      let!(:same_day_different_place) { FactoryBot.create :competition, competition_series: series, latitude: 51_501_620, longitude: -141_885, starts: competition.start_date }
