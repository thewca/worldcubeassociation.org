Rails.application.routes.draw do
  ...
  resources :competitions, only: [:index, :show, :edit, :update, :new, :create] do
    ...
    patch 'registrations/selected' => 'registrations#do_actions_for_slected', as: :registrations_do_actions_for_slected
    get 'registrations/export' => 'registrations#export', as: :registrations_export
