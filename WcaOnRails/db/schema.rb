...
ActiveRecord::Schema.define(version: 20150520080634) do
  ...
  create_table "devise_users_roles", id: false, force: :cascade do |t|
    t.integer "devise_user_id", limit: 4
    t.integer "role_id",        limit: 4
  end

  add_index "devise_users_roles", ["devise_user_id", "role_id"], name: "index_devise_users_roles_on_devise_user_id_and_role_id", using: :btree
