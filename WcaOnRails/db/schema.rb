...
ActiveRecord::Schema[7.1].define(version: 2024_01_17_091028) do
  ...
  create_table "roles_metadata_translators", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "locale"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
