...
- Added `AttemptResults` SQL table / TSV export file
- `value1-5` in `Results` will now be `NULL`
- See [Results and AttemptResults](#results-and-attemptresults) for more information on how this data interacts
...
| Field                   | Sample Value              |
|-------------------------|---------------------------|
| `export_date`           | `"2025-11-24T16:33:03+00:00"` |
...
| ResultAttempts                          | Individual attempts which make up a given Result   |
...
- The individual attempt/solve values which make up a result are in the ResultAttempts table,
